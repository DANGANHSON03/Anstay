...
const FloattingContactBt = () => {  
    ...
    return (
      ...
      <div className="contact-options">
        <a href="https://m.me/yourpage" target="_blank" rel="noopener noreferrer" className="contact-item">
          <img src={Mess} alt="Messenger" />
          <span>Chat Messenger (8h–21h)</span>
        </a>
        <a href="https://zalo.me/0916612772" target="_blank" rel="noopener noreferrer" className="contact-item">
