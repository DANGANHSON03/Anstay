        ...
        >
          <TabPane tab="Các vấn đề thường gặp" key="1">
            ...
            >
              {troubleshootItems.map((item) => (
                <Panel header={item.label} key={item.key} className="panel-content">
          ...
          <TabPane tab="Tạo issue" key="2">
            ...
            <div className="contact-f">
                <Form form={form} layout="vertical" className="custom-form" onFinish={onFinish}  onFinishFailed={onFinishFailed}>
                  ...
                  >
                  <Input placeholder="SĐT" onKeyPress={(event) => {
                  ...
                  >
                    <Input placeholder="Chi tiết vấn đề" />
                  </Form.Item>
